/*
Script de déploiement pour GestionArticles
...
GO
:setvar DatabaseName "GestionArticles"
:setvar DefaultFilePrefix "GestionArticles"
...
GO
PRINT N'Création de Table [dbo].[Article]...';
...
GO
PRINT N'Création de Procédure [dbo].[AllArticles]...';
...
RETURN 0
GO
PRINT N'Création de Procédure [dbo].[EditArticle]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[InsertArticle]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '50c5cd1f-f384-4e45-b65e-113c7875413d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('50c5cd1f-f384-4e45-b65e-113c7875413d')
